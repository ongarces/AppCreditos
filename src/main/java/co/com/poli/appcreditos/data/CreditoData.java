...
public class CreditoData {
    ...
    static{
        listaCreditos = new ArrayList<Credito>(){
            {
                add(new Credito("1212", "1234", "Catalina", 2000, "independiente", "vivienda", false));
                add(new Credito("1515", "4567", "Cristian", 500, "dependiente", "estudio", true));
                add(new Credito("1616", "7890", "Luisa", 3000, "independiente", "inversion", false));
                add(new Credito("1313", "1209", "Miguel", 1550, "dependiente", "vivienda", true));
